...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "}o@W.Y";
    private static final String UPDATED_EMAIL = "Ll@d.2\\";
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.firstName(UPDATED_FIRST_NAME).email(UPDATED_EMAIL).city(UPDATED_CITY);
